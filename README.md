...
- [Datastax Enterprise](https://www.datastax.com/products/datastax-enterprise?utm_source=awesome-github&utm_medium=referral&utm_campaign=dse-enterprise-backlinks&utm_term=backend-devplay&utm_content=cassandra-awesome-list) - Most widely used commercial distribution of Cassandra, integrated with Apache Spark (for SparkSQL, analytics), Apache Solr (for secondary index), Apache TinkerPop based Graph stored in Cassandra, and OpsCenter.
